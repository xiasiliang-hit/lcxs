...
<form class="form-inline definewidth m20" action="receipt/queryAll/1" method="post">   
	     ...
	     <tr>
           <td>${u.rid} </td>
            ...
            <td style="width: 50px">
                ...
                <a  onclick="details(${u.rid})" href="javascript:;">打款</a>

                    <a href="javascript:;" onclick="receipt(${u.rid})">驳回</a>
                </shiro:hasPermission>
            </td>
...
<form action="receipt/queryAll/1" id="pager" name="pager" method="post">
...
//excel导出方法
	...
	var millTime=enddate-startdate;
		if(millTime < 0 || start==undefined || start==null || start=="" || end==null || end==undefined || end==""){
		 ...
		 window.location.href="receipt/excelDowloadreceipt/"+1+"/"+start+"/"+end;
	});
...
//查询方法
 $('#sub').click(function(){
   ...
   window.location.href="receipt/queryAnyDayOfReceipt/"+start+"/"+end+"/"+1;
 });
