...
<form class="form-inline definewidth m20" action="receipt/queryAll/2" method="post"> 
       ...
       <c:forEach items="${pageModel.list }" var="u">
	     <tr>
            ...
            <td style="width:120px">
                ...
                <a href="javascript:;" onclick="receipt(${u.rid})">返回未审核</a>
                </shiro:hasPermission>
            </td>
        </tr>	
        </c:forEach>
</table>
<form action="receipt/queryAll/2" id="pager" name="pager" method="post">
...
//excel导出方法
	...
	var millTime=enddate-startdate;
		...
		window.location.href="receipt/excelDowloadreceipt/"+2+"/"+start+"/"+end;
	});
...
//查询方法
 $('#sub').click(function(){
   ...
   window.location.href="receipt/queryAnyDayOfReceipt/"+start+"/"+end+"/"+2;
 });
