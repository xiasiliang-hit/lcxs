...
<form class="form-inline definewidth m20"action="receipt/queryReceiptData" method="post" id="form">
	     ...
	     <tr>
            ...
            <td>${u.productname}</td>
        	  ...
        	  <td>${u.ctime}</td>
        	   ...
        	   <td>
				 <a href="ts/getTsInfo/${u.vid}">详情</a>
				</td>	 
        </tr>	
        </c:forEach>
</table>
<form action="receipt/queryReceiptData" id="pager" name="pager" method="post">
...
//查询方法
 $('#sub').click(function(){
   ...
   window.location.href="receipt/queryReceiptData;"
 });
