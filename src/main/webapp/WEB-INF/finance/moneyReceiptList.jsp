...
<form class="form-inline definewidth m20" action="receipt/queryAll/4" method="post"> 
...
<form action="receipt/queryAll/4" id="pager" name="pager" method="post">
...
//excel导出方法
	...
	var millTime=enddate-startdate;
		if(millTime < 0 || start==undefined || start==null || start=="" || end==null || end==undefined || end==""){
		 ...
		 window.location.href="receipt/excelDowloadreceipt/"+4+"/"+start+"/"+end;
	});
...
//查询方法
 $('#sub').click(function(){
   ...
   window.location.href="receipt/queryAnyDayOfReceipt/"+start+"/"+end+"/"+4;
 });
